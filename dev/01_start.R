...
##
golem::fill_desc(
  pkg_name = "budgetBuddy", # The Name of the package containing the App
  pkg_title = "Budget Buddy", # The Title of the package containing the App
  pkg_description = "A shiny app for personal budget management", # The Description of the package containing the App
